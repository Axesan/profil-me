    ...
    return (
        ...
        <div>
            ...
            <Box sx={{ marginBottom: '40px', display: "grid" }}>
                ...
                >
                    Créez, personnalisez et partagez des profils uniques qui reflètent votre personnalité et vos ambitions.
                </Typography>
            ...
            <Box sx={{ marginBottom: '40px' }}>
                ...
                >
                    "Le design n’est pas seulement ce à quoi ça ressemble et ce que ça fait ressentir. Le design, c’est comment ça fonctionne." – Steve Jobs
                </Typography>
                <Typography
                    variant="body2"
                    sx={{
            ...
            <Box>
                ...
                <Typography variant="body2" sx={{ marginBottom: '10px' }}>
                    "Simple à utiliser et des designs incroyables. Je recommande !" – Julien
                </Typography>
            </Box>
        </div>
